    ...
    <main id="startx" class="content-view mdui-container">
        <div class="mdui-container">
            <div class="mdui-typo">
                ...
                <p>5.基于<a
                        href='http://www.apache.org/licenses/LICENSE-2.0.html'>Apache2.0</a>开源协议开源,使用过程中涉及到的一切可能造成损失的因素,由运营者承担,与本人无关.
                </p>
                <p>6.禁止倒卖本程序.</p>
                ...
                <p>5.有任何问题,请尝试通过<a href='mailto:contact@xcsoft.top'>contact@xcsoft.top</a>或<a
                        href='//blog.xsot.cn'>BLOG</a>获取帮助.
                </p>
            </div>
        </div>
    </main>
...
<!-- 页面内JavaScript文件 -->
<script>
console.log("\n %c XCSOFT %c XSOT.CN ", "color:#444;background:#eee;padding:5px 0;",
