...
<main id="startx" class="content-view mdui-container">
    <div class="mdui-container">
        <div class="mdui-typo">
            ...
            <p>5.基于<a href='http://www.apache.org/licenses/LICENSE-2.0.html'>Apache2.0</a>开源协议开源,使用过程中涉及到的一切可能造成损失的因素,由运营者承担,与本人无关.
            </p>
            <p>6.禁止倒卖本程序.</p>
            ...
            <p>
                4.至此,已经安装完毕,请注意如果任然无法发送邮件,可能是服务商屏蔽了25等常用smtp端口,请尝试与服务商取得联系得到支持,同时也注意服务器是否放通了该类端口,或者查看是否是WAF(Nginx防火墙)屏蔽了海外访问等常见问题.</p>
            <p>5.有任何问题,请尝试通过<a href='mailto:contact@xcsoft.top'>contact@xcsoft.top</a>或<a href='//blog.xsot.cn'>BLOG</a>获取帮助.
            </p>
        </div>
    </div>
</main>
