...
?>
    <div class="mdui-container">
        ...
        <br/>&emsp;<a href="write.php" class="mdui-btn mdui-btn-dense mdui-color-theme-accent mdui-ripple"><i
                    class="mdui-icon material-icons">&#xe163;</i>&emsp;立即写信</a>
        <br/>
        <div class="mdui-typo">
            <blockquote>
                <p>未来的你,过的还好吗?
